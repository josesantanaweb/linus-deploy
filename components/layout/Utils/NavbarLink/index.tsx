...
const NavbarLinkLanding = ({ link, isFooter }: { link: Link, isFooter: boolean }) => {
  ...
  return (
    <div ref={ref} className="relative">
      <a
        href={link.href}
        className={`btn hover:bg-navy-blue-900 text-white ${isFooter ? 'px-0' : 'px-4'} h-11 text-sm font-bold flex items-center ${
