...
const Roadmao = ({
  ...
  const roadmap = [
    ...
    },
    {
      title: 'Q69 2024',
      description: [
        'Linea Surge (Cohete y Fuegos emojis)',
        'CEX Listings',
        'Top Linea Memecoin',
        'Pengu game',
        'Pengu Stories (3D Videos)',
      ],
    },
  ]
  return (
        ...
        <div className="relative flex items-start max-lg:items-center max-lg:flex-col max-lg:gap-[140px] justify-between w-full xl:w-[85%] mx-auto max-lg:overflow-hidden">
          {roadmap.map((item, index) => (
            <div className="relative flex flex-col gap-10 px-5 w-[28%] max-lg:w-[58%] max-sm:w-[90%]">
              ...
              <div className="card text-center text-white text-xs font-normal max-xl:px-10 px-16 py-8 rounded-[15px]">{
          ...
          {/* <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 line-gradient-vertical h-[729px] w-1 z-[-1] lg:hidden"></div> */}
